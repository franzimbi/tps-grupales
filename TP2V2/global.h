...
typedef enum {TODO_OK, USUARIO_YA_LOGEADO, USUARIO_INEXISTENTE, USUARIO_NO_LOGEADO, FEED_VACIO,
            NO_LOGEADO_O_POST_INEXISTENTE, SIN_LIKES_O_POST_INEXISTENTE, POST_SIN_LIKES_O_INEXISTENTE, ERROR_MEMORIA} status_t;
